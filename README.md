...
Integração não oficial para a **CeX Portugal** no Home Assistant. Este repositório é o mirror HACS da integração mantida em `ha_apps/integrations/cex`.
